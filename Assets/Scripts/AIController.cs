...
public class AIController : MonoBehaviour
{
    ...
    public float edgeDistance = 0.5f;               //  Max distance to calc the a min and a maximum raycast when hits something
    ...
    private void Patroling()
    {
        ...
        {
            m_PlayerNear = false;           //  The player is no near when the enemy is patrolling
